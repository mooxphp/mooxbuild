                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @endcan @can('view', $sync)
                                        <a
                                            href="{{ route('syncs.show', $sync) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $sync)
                                        <form
                                            action="{{ route('syncs.destroy', $sync) }}"
                                            method="POST"
