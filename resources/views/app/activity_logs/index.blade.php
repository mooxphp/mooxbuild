<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.activity_logs.index_title')
        </h2>
    </x-slot>
...
{{ json_encode($activityLog->properties) ?? '-' }}</pre
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            href="{{ route('activity-logs.edit', $activityLog) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $activityLog)
                                        <a
                                            href="{{ route('activity-logs.show', $activityLog) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
