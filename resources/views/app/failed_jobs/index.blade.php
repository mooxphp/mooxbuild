<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.failed_jobs.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    <div
                                        ...
                                        "
                                    >
                                        @can('update', $failedJob)
                                        <a
                                            href="{{ route('failed-jobs.edit', $failedJob) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $failedJob)
                                        <a
                                            href="{{ route('failed-jobs.show', $failedJob) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $failedJob)
                                        <form
                                            action="{{ route('failed-jobs.destroy', $failedJob) }}"
                                            method="POST"
