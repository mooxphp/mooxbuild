<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.continents.index_title')
        </h2>
    </x-slot>
                ...
                <div class="mb-5 mt-4">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="md:w-1/2 text-right">
                            @can('create', App\Models\Continent::class)
                            <a
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @endcan @can('view', $continent)
                                        <a
                                            href="{{ route('continents.show', $continent) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $continent)
                                        <form
                                            action="{{ route('continents.destroy', $continent) }}"
                                            method="POST"
